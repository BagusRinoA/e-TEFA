        ...
        <div class="admin-container">
            <div class="admin-page-header">
                <div>
                    ...
                    <p class="admin-page-subtitle">Update product details and inventory.</p>
                </div>
                ...
                <form action="{{ route('admin.products.update', $product) }}" method="POST" enctype="multipart/form-data">
                    ...
                    <div class="admin-form-grid">
                        ...
                        <label class="block">
                            ...
                            <input type="text" name="category" value="{{ old('category', $product->category) }}" class="admin-input" required>
                        </label>
                        <label class="block">
                        ...
                        <label class="block">
                            ...
                            <input type="number" name="stock" value="{{ old('stock', $product->stock) }}" class="admin-input" required>
                        </label>
                        <label class="block" style="grid-column: 1 / -1;">
                            ...
                            @if ($product->image_url)
                                <div class="mt-3 mb-3">
                                    ...
                                    <img src="{{ $product->image_url }}" alt="{{ $product->name }}" class="max-h-48 w-auto rounded-lg border border-gray-200 object-contain shadow-sm">
                                </div>
                            @endif
                            ...
                            <p class="mt-2 text-xs text-muted-foreground">Format: JPG, PNG, WebP. Maks. 10 MB. Kosongkan jika tidak ingin mengganti gambar.</p>
                        </label>
                        <script>
                        ...
                        <label class="block" style="grid-column: 1 / -1;">
                            ...
                            <textarea name="description" rows="5" class="admin-input" required>{{ old('description', $product->description) }}</textarea>
                        </label>
                        <label class="inline-flex items-center gap-2" style="grid-column: 1 / -1;">
                            <input type="checkbox" name="featured" value="1" {{ old('featured', $product->featured) ? 'checked' : '' }} class="rounded border-gray-300 text-primary focus:ring-primary">
