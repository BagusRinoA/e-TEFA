...
@section('title', 'Edit Konfigurasi Point Earning')
    ...
    <div class="admin-page">
        <div class="admin-container">
            <div class="admin-page-header">
                <div>
                    <h1 class="admin-page-title">Edit Konfigurasi Point</h1>
                    <p class="admin-page-subtitle">Ubah konfigurasi penghasilan poin.</p>
                </div>
        ...
        <div class="admin-form-card">
            <form action="{{ route('admin.loyalty.configurations.update', $configuration) }}" method="POST">
                @csrf
                @method('PUT')
                ...
                <div class="admin-form-grid">
                    <label class="block">
                        ...
                        <input type="number" name="min_purchase_amount" step="0.01" min="0" value="{{ old('min_purchase_amount', $configuration->min_purchase_amount) }}" required class="admin-input">
                    ...
                    <label class="block">
                        ...
                        <input type="number" name="max_purchase_amount" step="0.01" min="0" value="{{ old('max_purchase_amount', $configuration->max_purchase_amount) }}" class="admin-input">
                    ...
                    <label class="block" style="grid-column: 1 / -1;">
                        ...
                        <input type="number" name="points_earned" min="0" value="{{ old('points_earned', $configuration->points_earned) }}" required class="admin-input">
                    ...
                    <label class="block" style="grid-column: 1 / -1;">
                        ...
                        <textarea name="description" rows="3" class="admin-input">{{ old('description', $configuration->description) }}</textarea>
                    ...
                    <label class="inline-flex items-center gap-2" style="grid-column: 1 / -1;">
                        <input type="checkbox" name="is_active" value="1" {{ old('is_active', $configuration->is_active) ? 'checked' : '' }} class="rounded border-gray-300 text-primary focus:ring-primary">
